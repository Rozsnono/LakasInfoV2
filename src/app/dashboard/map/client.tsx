...
export default function MapPageClient({ houses }: MapPageClientProps) {
    const [activeHouse, setActiveHouse] = useState<MapHouse | null>(null);
    const [isSheetOpen, setIsSheetOpen] = useState(true);

    useEffect(() => {
        if (houses && houses.length > 0 && !activeHouse) {
                    ...
                    isSheetOpen && (
                        <motion.div
                            ...
                            {houses.length > 0 ? (
                                ...
                                <div className="flex-1 flex items-center justify-center text-white/30 text-xs font-bold uppercase tracking-widest text-center px-6 pb-10">
