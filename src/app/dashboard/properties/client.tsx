...
import { HousePlus, LogIn, ChevronRight, ArrowLeft, Home, MapPin, CheckCircle2 } from "lucide-react";
import Link, { useRouter } from "@/contexts/router.context";
import { selectHouseAction } from "@/app/actions/house";
...
interface House {
    ...
    name: string;
    address?: string;
    isActive?: boolean; // Igaz, ha ez az éppen kiválasztott otthon
}
...
export default function HouseManagerClient({ houses }: HouseManagerClientProps) {
        ...
        >
            ...
            <div className="relative z-10 w-full max-w-sm mx-auto flex flex-col gap-10">
                ...
                <motion.div variants={itemVariants} className="space-y-4">
                    <h2 className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] ml-2">Saját háztartások</h2>
